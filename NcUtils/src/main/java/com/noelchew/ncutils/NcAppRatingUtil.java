 ...
 */
public class NcAppRatingUtil {

    private static final String TAG = "NcAppRatingUtil";
    private static final String PREF_NAME = "NcAppRatingUtil";
    ...
    public NcAppRatingUtil(Context context) {
        this.context = context;
        onStart();
    }

    public NcAppRatingUtil(Context context, Config config) {
        this.context = context;
        this.sConfig = config;
        onStart();
    }

    public NcAppRatingUtil(Context context, Callback callback) {
        this.context = context;
        this.sConfig.setCallback(callback);
        onStart();
    }

    public NcAppRatingUtil(Context context, Config config, Callback callback) {
        this.context = context;
...
//                    sCallback.onYesClicked();
                    ...
                    if (ratingBar.getRating() >= sConfig.mUpperBound) {
                        ...
                        ToastUtil.toastShortMessage(context, R.string.nc_utils_rate_dialog_please_select_a_rating);
                    } else {
